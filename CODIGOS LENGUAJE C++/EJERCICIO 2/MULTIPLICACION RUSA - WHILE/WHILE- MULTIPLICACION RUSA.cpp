...
// PROCESO: Función que realiza la multiplicación rusa con bucle while
int multiplicacionRusa(int numeroMenor, int numeroMayor) {
    ...
    // PROCESO: Bucle while para realizar la multiplicación rusa
    while (numeroMenor > 0) {
        ...
        // PROCESO: Actualizar valores para el siguiente paso
        numeroMenor /= 2;
        numeroMayor *= 2;
    }
